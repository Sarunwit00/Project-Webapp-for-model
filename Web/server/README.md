...
## แชร์ให้คนอื่นเข้าผ่านเน็ต (ชั่วคราว ฟรี)

ใช้ Cloudflare Tunnel เปิดลิงก์สาธารณะชั่วคราวให้คนอื่นเข้าเว็บจากที่ไหนก็ได้:

1. เปิด backend ก่อน — ดับเบิลคลิก `run.bat`
2. เปิดอีกหน้าต่าง — ดับเบิลคลิก `share.bat` (ครั้งแรกจะโหลด `cloudflared.exe` ให้เอง)
3. คัดลอกลิงก์ `https://xxxxx.trycloudflare.com` ที่ขึ้นมา ส่งให้คนอื่นเข้าได้เลย

ข้อจำกัด: ลิงก์ใช้ได้เฉพาะตอนเครื่องคุณเปิด + `run.bat` และ `share.bat` รันอยู่ และลิงก์จะเปลี่ยนใหม่ทุกครั้งที่เปิด tunnel ใหม่ (เหมาะกับโชว์งาน/ทดสอบ ไม่ใช่ 24/7) — ถ้าอยากออนไลน์ถาวร ลองดู Hugging Face Spaces
